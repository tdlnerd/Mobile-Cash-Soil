...
function GemL79 () {
var l79choice = Random.Range(0,Level3Ore.length);
var clone = Instantiate(Level3Ore[l79choice]);
clone.transform.position.x = Random.Range(L1XMin, L1XMax);
...
function EnemyL5 () {
var e5choice = Random.Range(0,L3Enemy.length);
var clone = Instantiate(L3Enemy[e5choice]);
clone.transform.position.x = Random.Range(L1XMin, L1XMax);
clone.transform.position.y = Random.Range(L5YMin, L5YMax);
}

function EnemyL6 () {
var e6choice = Random.Range(0,L3Enemy.length);
var clone = Instantiate(L3Enemy[e6choice]);
clone.transform.position.x = Random.Range(L1XMin, L1XMax);
clone.transform.position.y = Random.Range(L6YMin, L6YMax);
}

function EnemyL79 () {
var e79choice = Random.Range(0,L3Enemy.length);
var clone = Instantiate(L3Enemy[e79choice]);
clone.transform.position.x = Random.Range(L1XMin, L1XMax);
clone.transform.position.y = Random.Range(L7YMin, L7YMax);
}
